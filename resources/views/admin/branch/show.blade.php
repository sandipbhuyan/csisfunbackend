                            ...
                            <h4>
                                ...
                                <div>
                                    ...
                                    <a class="action" href="{{ route($route['index']) }}">
                                        <button style="margin-top:-15px;" class="btn btn-info btn-block"><i
                                                class="fa fa-book"></i> {{$showvar['seeall']}}</button>
                                    </a>
                                    <hr/>
                                    <a class="action"
                                       href="{{ route('category.createByBranch', ${$singlepostvar}->id) }}">
                                        <button style="margin-top:-15px;" class="btn btn-success btn-block"><i
                                                class="fa fa-plus"></i> ADD CATEGORY TO BRANCH
                                        </button>
                                    </a>
                                </div>
                            </h4>
